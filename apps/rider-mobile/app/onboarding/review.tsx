...
/**
 * RO6 — Review & submit step (placeholder).
 * Shows the stepper at the current step and a "coming soon" body. The full
 * review-and-submit form lands here in a follow-up.
 */
    ...
    <View style={styles.screen}>
      ...
      <View style={styles.body}>
        <View style={styles.comingIconWrap}>
          <ClipboardCheck size={36} color={colors.primary} strokeWidth={2} />
        </View>
        <Text style={styles.comingTitle}>{t('rider.onboarding.review.title')}</Text>
        <Text style={styles.comingText}>{t('rider.onboarding.review.comingSoon')}</Text>
      </View>
