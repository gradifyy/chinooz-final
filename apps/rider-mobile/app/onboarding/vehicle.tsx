...
/**
 * RO4 — Vehicle step (placeholder).
 * Shows the stepper at the current step and a "coming soon" body. The full
 * vehicle-details form lands here in a follow-up.
 */
    ...
    <View style={styles.screen}>
      ...
      <View style={styles.body}>
        <View style={styles.comingIconWrap}>
          <Bike size={36} color={colors.primary} strokeWidth={2} />
        </View>
        <Text style={styles.comingTitle}>{t('rider.onboarding.vehicle.title')}</Text>
        <Text style={styles.comingText}>{t('rider.onboarding.vehicle.comingSoon')}</Text>
      </View>
